---
title: "Read and process OTM data and Generate OTM spline models"
output:
  html_document:
    toc: true
    toc_depth: 2
...
# Generate OTM cubic spline models
...
For instance, the OTMs we used to validate our methodology were programmed to record a temperature measurement every 2 minutes, leading to a total of 30 observations / hour. Assuming a `knot_p = 0.1` that would indicate that our model has 3 knots / h. As a general recommendation, we recommend setting `knot_p` to a higher value if the frequency of observations is low, but the decision ultimately comes to the user of the methodology. Please reach out to garciacosto@gmail.com for recommendations. 
