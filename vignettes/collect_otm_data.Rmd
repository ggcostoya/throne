...
```{r, echo=FALSE, out.width = '80%', fig.align = 'center', fig.cap = "Figure 2. An operative temperature model (OTM) used for this study"}
...
```{r, echo = FALSE, fig.align = 'center', fig.width = 6, fig.height = 6, fig.cap = "Figure 3: Elevational profile of our area of study"}
# filter flight data
flight <- flights_data[flights_data$mod_start == 515,]
