...
1.  That the temperature logger has a **temperature range** that falls outside of the typical range of temperatures that are expected on the area of interest.
2.  That it has as high recording accuracy.
