---
title: "Match flight to OTM data and Predict Thermal Landscapes"
output:
  html_document:
    toc: true
    toc_depth: 2
...
1. Very few OTMs are needed to explain the majority of the sites thermal dynamics. In the example data set, only `5` out of the `33` OTMs deployed were needed to explain more than >50% of the variability of the site.
...
1. An `otm_splines` nest `tibble` obtained through the `generate_otm_splines`.
