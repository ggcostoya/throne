...
3. The spatial `resolution` to which the `.tif` files should be summarized to in $m^2$. This parameter will control the  This parameter will control the spatial resolution of the final output and should be chosen according to the spatial scale of the study organism.
