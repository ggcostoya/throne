...
```{r, echo=FALSE, out.width = '60%', fig.align = 'center', fig.cap = "Study area within the Great Basin of Northern Nevada, the red rectangle indicates the specific area of interest we will be focusing on."}
knitr::include_graphics("images/c_study_area.png")
```

```{r, echo=FALSE, out.width = '60%', fig.align = 'center', fig.cap = "Topography of the area of study. A ridge divides the area between an eastern-facing side a relatively gentle slope and a western-facing side with a steep slope even becoming a precipice in some spots"}
...
```{r, echo=FALSE, out.width = '60%', fig.align = 'center', fig.cap = "A western fence lizard basking on a rock in the study area. Note that this individual is marked through a color combination painted on its side (Blue - Silver - Pink) used to identify it in the field."}
...
```{r, echo = FALSE}
load("C:/Users/ggarc/OneDrive/research/throne/case_study_data/c_flights_metadata.RData")
c_flights_metadata
```
...
```{r, echo=FALSE, out.width = '60%', fig.align = 'center', fig.cap = "An operative temperature model of the type used for this study."}
...
```{r, echo = FALSE}
load("C:/Users/ggarc/OneDrive/research/throne/case_study_data/c_otms_metadata.RData")
c_otms_metadata
load("C:/Users/ggarc/OneDrive/research/throne/case_study_data/c_flights_data.RData")
```

```{r, fig.height= 6, fig.width = 4, fig.align = 'center', fig.cap = "Map of the study area (shaded) with the locations of the OTMs deployed. Note that not all OTMs fell inside of the area of study but due to their proximity, they can be used for subsequent analysis within the pipeline"}
ggplot() +
...
```{r, echo = FALSE}
load("C:/Users/ggarc/OneDrive/research/throne/case_study_data/c_example_otm.rda")
head(c_example_otm)
```
...
```{r, echo = FALSE}
load("C:/Users/ggarc/OneDrive/research/throne/case_study_data/c_otms_data.RData")
```
...
```{r, echo = FALSE}
load("C:/Users/ggarc/OneDrive/research/throne/case_study_data/c_otms_splines.RData")
```
...
```{r, echo = FALSE}
load("C:/Users/ggarc/OneDrive/research/throne/case_study_data/c_matches.RData")
```
...
```{r, echo = FALSE}
load("C:/Users/ggarc/OneDrive/research/throne/case_study_data/lizard_mr.rda")
lizard_mr <- lizard_mr %>% group_by(id) %>% mutate(obs = n()) %>% filter(obs > 3) %>% 
  slice(chull(longitude, latitude)) %>% ungroup() %>% select(id, sex, year, doy, mod, latitude, longitude)
```
...
```{r, warning = FALSE, message = FALSE, fig.align = 'center', fig.height = 4, fig.width = 6}
example_pred_lizards %>% 
