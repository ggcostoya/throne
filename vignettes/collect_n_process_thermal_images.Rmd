...
```{r, echo=FALSE, out.width = '80%', fig.align = 'center', fig.cap = "Figure 3. When using ground control points (GCPs) for missims, it is important that they are visible across all flights"}
...
```{r, echo=FALSE, out.width = '80%', fig.align = 'center', fig.cap = "Figure 4. How to create and start processing a project in Pix4Dmapper"}
...
```{r, echo=FALSE, out.width = '80%', fig.align = 'center', fig.cap = "Figure 5. Ground control points (GCPs) will show as blue/green markers in the rayCloud editor once they have been loaded and optimized with the point cloud"}
